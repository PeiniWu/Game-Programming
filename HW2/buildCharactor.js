...
function buildHead(WW, HH, DD) {
	...
	let material = new THREE.MeshBasicMaterial({map: texture, side:THREE.DoubleSide});//雙面
	let mesh = new THREE.Mesh(geometry,material);
    mesh.position.y = WW;//高度
	head.add(mesh);
	return head;;
}	
//建立身體
...
function buildLegs(WW, HH, DD) {
    ...
    vertices.push(-WW/2,HH/2,-DD/2, -WW/2,HH/2,DD/2, WW/2,HH/2,DD/2, WW/2,HH/2,-DD/2 ); // 4,0,1,5
    indices.push (16,17,18, 16,18,19); // [0,1,2, 0,2,3] + 16
    uvs.push (a.u/UU,a.v/VV, e.u/UU,e.v/VV, f.u/UU,f.v/VV, b.u/UU,b.v/VV); // a,e,f,g
